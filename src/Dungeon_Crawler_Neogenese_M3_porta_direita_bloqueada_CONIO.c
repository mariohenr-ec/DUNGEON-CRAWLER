    ...
    while (1) {
        ...
        if (tecla == 'o' || tecla == 'O') {
            ...
            if (mapa[proxX][proxY] == 'O') {
                ...
                /* Destroi a fileira de paredes '*' ao lado esquerdo de E. */
                for (i = 1; i < 14; i++) {
                    if (mapa[i][15] == '*') {
                        mapa[i][15] = ' ';
                    }
                ...
                printf("\nParedes destruidas\n");
                printf("E agora pode conversar com voce quando voce chegar perto.\n");
                printf("Pressione qualquer tecla para continuar...");
                getch();
            }
            ...
            if (mapa[proxX][proxY] == 'E') {
                if (botaoAtivado == 1) {
                    printf("\n[E]: Dialogo ainda sera inserido aqui.\n");
                    jaConversouE = 1;
                } else {
                    printf("\nE esta preso. Ative o botao primeiro.\n");
                }
                printf("Pressione qualquer tecla para continuar...");
                getch();
                continue;
        ...
        if (jaConversouE == 1) {
            system("cls");
            printf("--------------------------------------------\n");
            printf("         FIM PROVISORIO DA MASMORRA 3\n");
            printf("--------------------------------------------\n\n");
            printf("Depois voce pode inserir a conversa completa do NPC E.\n");
            printf("Pressione qualquer tecla para voltar ao menu...");
            getch();
            break;
        }
